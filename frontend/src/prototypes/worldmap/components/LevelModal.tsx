...
// Modal de detalhes da fase. Fases LOCKED mostram painel "bloqueada".
  ...
  return (
    <AnimatePresence>
      {level && (
        ...
        >
          <motion.div
            className={`wm-modal ${level.status === 'LOCKED' ? 'wm-modal-locked' : ''}`}
            ...
            {level.status === 'LOCKED' ? (
              ...
              <>
                ...
                <div className="wm-modal-meta">
                  ...
                  <span
                    className={`wm-status wm-status-${level.status.toLowerCase()}`}
                  >
