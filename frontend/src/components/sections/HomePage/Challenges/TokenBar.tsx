...
/**
 * Barra de fichas (tokens de operacao). Mostra o saldo como fichas de arcade e,
 * quando abaixo do teto, o tempo ate a proxima recarga. Usa tokens de tema (dark/light).
 */
